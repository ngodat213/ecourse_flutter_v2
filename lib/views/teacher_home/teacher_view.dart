...
class TeacherHomeView extends BaseView<TeacherVM> {
  const TeacherHomeView({super.key});

  @override
  TeacherVM createViewModel(
    BuildContext context,
    Map<String, dynamic>? arguments,
  ) {
    return TeacherVM(context);
  }

  @override
  PreferredSizeWidget? buildAppBar(BuildContext context, TeacherVM vm) {
    return AppBar(
  ...
  @override
  Widget buildView(BuildContext context, TeacherVM vm) {
    return SafeArea(
